		...
		<div id="list-usuario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="numeroComprobanteFiscal" title="${message(code: 'usuario.numeroComprobanteFiscal.label', default: 'Numero Comprobante Fiscal')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: usuarioInstance, field: "numeroComprobanteFiscal")}</td>
